...
class ImageDownloadJobSchema(BaseModel):
    """
    ...
    id: StrictStr
    image_ids: List[StrictStr]
    status: ImageDownloadStatus
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["created_at", "download_url", "environment_id", "id", "image_ids", "status", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImageDownloadJobSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImageDownloadJobSchema from a dict"""
        if obj is None:
            return None
